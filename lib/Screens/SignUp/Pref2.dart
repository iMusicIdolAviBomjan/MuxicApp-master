...
class Pref2Screen extends StatefulWidget {
  const Pref2Screen({Key? key}) : super(key: key);

  @override
  _Pref2ScreenState createState() => _Pref2ScreenState();
}

class _Pref2ScreenState extends State<Pref2Screen> {
