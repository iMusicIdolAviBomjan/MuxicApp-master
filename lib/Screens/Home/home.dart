...
class _HomePageState extends State<HomePage> {
  ...
  bool loginStatus=
      Hive.box('settings').get('login', defaultValue: false) as bool;
  ...
  Future _signOut(bool loginStatus) async {
    //int? status;
                ...
                SliverList(
                  delegate: SliverChildListDelegate(
                    [
                      ...
                      ListTile(
                        title: Text(
                            loginStatus == true ? 'Sign out' : 'Sign in'
                        ),
                        contentPadding:
                        const EdgeInsets.symmetric(horizontal: 20.0),
                        leading:
                                  ...
                                  flexibleSpace: LayoutBuilder(
                                    builder: (
                                      ...
                                      return FlexibleSpaceBar(
                                        ...
                                        ///comment the pop up input box (username input)
                                        /*GestureDetector(
                                          onTap: () async {
          ...
          child: ValueListenableBuilder(
            ...
            builder: (BuildContext context, int indexValue, Widget? child) {
              return AnimatedContainer(
                ...
                //adjust bottomBar's item position
